...
public class PasswordUtil {
    ...
    private static boolean verifyPassword(char[] password, String correctHash)
        ...
        if (params.length != HASH_SECTIONS) {
            throw new org.abondar.experimental.wsboard.server.exception.InvalidHashException(
        ...
        if (!params[HASH_ALGORITHM_INDEX].equals("sha1")) {
            throw new org.abondar.experimental.wsboard.server.exception.CannotPerformOperationException(
    ...
    private static byte[] pbkdf2(char[] password, byte[] salt, int iterations, int bytes)
            throws org.abondar.experimental.wsboard.server.exception.CannotPerformOperationException {
        try {
